...
Photographs are used under the [Pexels licence](https://www.pexels.com/license/),
which allows free use, including commercially, without attribution. Credit is
recorded here anyway, because the people who took them deserve it.
...
Each photograph was checked against the stretch's own `steps` in `stretches.js`
